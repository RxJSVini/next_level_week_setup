...
export default function HabitDay({ completed = 0, amount = 0, date }: HabitDayProgess) {
    ...
    <Popover.Root>
      ...
      <Popover.Portal>
        <Popover.Content className="min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col">
          ...
          <Checkbox.Root className="mt-6 flex- flex-col gap-3 group">
